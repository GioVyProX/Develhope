...
public class Main {
    ...
    private static void exercise1() {
        ...
        int sumForB = 0;
        for (int items : itemsB){
            sumForB = sumForB + items;
        }
    ...
    private static void exercise2() {
        ...
        for (int i = 0; i < items.size(); i++) {
            maxNumber = Math.max(items.get(i), maxNumber);

            minNumber = Math.min(items.get(i), minNumber);
        }
        System.out.println("The max is " + maxNumber);
        System.out.println("The max is " + minNumber);

        //Actually you can do this way as well:
       // System.out.println("\nExercise 2:");
        //List<Integer> items = Arrays.asList(300, 23, 56, 55, 84);
        //int minNumber = Integer.MAX_VALUE;
        //int maxNumber = 0;
...
// Write code here
    ...
    private static void exercise4() {
        ...
        int i = 8;
        for (
                int timesTableCurrentValue = i; // <---- Edit this line
                timesTableCurrentValue <= i*10; // <---- Edit this line
                timesTableCurrentValue = timesTableCurrentValue + i // <---- Edit this line
        ) {
    ...
    private static void exercise5() {
        for (int timesTableNumber = 1; timesTableNumber <= 10; timesTableNumber++) {
            // Your fori loop here
            for (int i = 1; i <= 10 ; i++) {
            int multiplication = timesTableNumber * i;
