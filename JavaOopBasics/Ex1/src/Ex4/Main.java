...
public class Main {
    ...
    private static final int MAX_NUMBER_OF_DAY_IN_A_WEEK = 7;
    ...
    public static void exercise1() {
        ...
        int totalCount = 0;
        for (int i = 0; i < 100; i++) {
            int luckyRolls = 0;  //added here = 0, so we don't have to do at the end of the fori loop
            while (rollD6() == 6) {
...
//            luckyRolls = 0;
    ...
    private static void exercise4() {
        ...
        for (int week = 0; week < NUMBER_OF_WEEKS_IN_A_YEAR; week++) {
            for (int day = 0; day < MAX_NUMBER_OF_DAY_IN_A_WEEK; day++) {
                for (int hour = 0; hour < MAX_HOURS_PER_DAY; hour++) {
