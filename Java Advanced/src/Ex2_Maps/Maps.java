...
public class Maps {
    ...
    private static void exercise1() {
        ...
        myFirstMap.put(10, "Bananas");
        myFirstMap.put(19, "Coconuts");
        myFirstMap.put(1, "Girlfriend");
    ...
    private static void exercise3() {
        ...
        for (Integer fruit : fruitWeights.values()) {

            totalWeight = totalWeight + fruit;
        }
