...
public class Main {
        ...
        private static void exercise2() {
            ...
            //this will print out all the elements of the same collection as we implemented the .addAll method
            ...
            //this will add each element contained in fruitsList in our fruitsSet, I guess those are same collection,
            //so the .addAll will "sum" elements of both set and list
            System.out.println(fruitsSet);
        }
        ...
        private static void exercise3() {
            ...
            Set<Integer> numbers = Set.of(1, 6, 3, 5, 2, 7, 8, 9, 10);
