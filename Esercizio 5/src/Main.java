...
public class Main {
    ...
    private static void exercise4Bonus() {
        ...
        // Print the smallest point greater than the ourValue and equal to a mathematical integer
        System.out.println(ourValue + " after using ceiling=" + Math.ceil(ourValue));
        // Print the highest point smaller than the ourValue equal to a mathematical integer
        System.out.println(ourValue + " after using floor=" + Math.floor(ourValue));
        // It rounds up ourValue and return its integer
        System.out.println(ourValue + " after using round=" + Math.round(ourValue));
        // It returns ourValue times ourValue
        ...
        // Print ourValue times a random number between 0 and 1
